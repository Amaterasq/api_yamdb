...
- [ ] Частичное обновление или удаление отзыва по id.
    ...
    - _Анонимные запросы запрещены._
- [X] Получение списка всех комментариев к отзыву и комментарий для отзыва по id.
    - _Доступно без токена._
...
```
:white_check_mark:  Получить список всех комментариев к отзыву по id.
```Python
`GET' /api/v1/titles/{title_id}/reviews/{review_id}/comments/
```
:white_check_mark: Добавить новый комментарий для отзыва.
```Python
`POST, PATCH, DELETE' /api/v1/titles/{title_id}/reviews/{review_id}/comments/
```
```
{
"text": "string"
